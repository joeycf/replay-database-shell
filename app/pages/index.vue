 ...
 */
function pickCount(summary: Record<string, unknown>): number | null {
...
<template>
  <div class="flex min-h-screen flex-col bg-bg font-ui text-text">
    ...
    <main id="main" class="mx-auto w-full max-w-[1120px] flex-1 px-5 md:px-8">
      ...
      >
        ...
        >
          <span class="accent-bar h-1 w-full flex-none" aria-hidden="true" />
